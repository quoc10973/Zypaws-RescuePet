...
const WaveBackground = () => {
    return (
        <div className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] bg-gradient-to-b from-zinc-100 to-zinc-300 z-10">
            ...
            <div className="absolute p-3 top-0 left-0 right-0 flex justify-center items-center mt-3 space-x-5 h-full z-20">
                ...
                <div className="p-6 rounded-lg w-full sm:w-1/3 bg-transparent text-center relative sm:hidden block">
                    <img src={assets.confetti2} alt="Decorate 5" className="absolute top-0 ml-2 left-1/2 transform -translate-x-1/2 mt-[-45px] w-34 h-32" />
                    <h3 className="text-5xl font-playwrite font-semibold text-fuchsia-950 mt-20">
                ...
                <div className="p-6 rounded-lg w-1/3 bg-transparent text-center relative hidden sm:block">
                    <img src={assets.confetti1} alt="Decorate 5" className="absolute top-0 left-1/2 transform -translate-x-1/2 w-52 h-56 mt-[-160px]" />
                    <h3 className="text-5xl font-playwrite font-semibold text-fuchsia-950 mt-20">
                ...
                <div className="p-6 rounded-lg w-1/3 bg-transparent text-center relative hidden sm:block">
                    <img src={assets.confetti3} alt="Decorate 5" className="absolute top-0 ml-1 left-1/2 transform -translate-x-1/2 w-30 h-20 mt-[-20px]" />
                    <h3 className="text-5xl font-playwrite font-semibold text-fuchsia-950 mt-20">
                ...
                <div className="p-6 rounded-lg w-1/3 bg-transparent text-center relative hidden sm:block">
                    <img src={assets.confetti2} alt="Decorate 5" className="absolute top-0 ml-2 left-1/2 transform -translate-x-1/2 w-52 h-56 mt-[-160px]" />
                    <h3 className="text-5xl font-playwrite font-semibold text-fuchsia-950 mt-20">
