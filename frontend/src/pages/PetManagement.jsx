...
const PetManagement = () => {
    ...
    const uploadImage = async (file) => {
        ...
        formData.append("upload_preset", "zypaws_preset"); // Thay bằng upload_preset của bạn
        formData.append("folder", "Pets");

        try {
            const response = await fetch("https://api.cloudinary.com/v1_1/dl0dri4pf/image/upload", {
                method: "POST",
                body: formData
            });
